...
func main() {
	...
	// Initialize router
	router := api.NewRouter(cfg, repos, log, wsHub, db)
	...
	// TODO: Disconnect all adapters
	// This will be implemented when we have access to the handlers instance
	// For now, adapters will be disconnected automatically when the process exits
