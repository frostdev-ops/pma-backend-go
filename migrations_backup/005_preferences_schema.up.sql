...
CREATE INDEX idx_dashboards_updated ON user_dashboards(updated_at);
...
CREATE INDEX idx_suggestions_user_status ON automation_suggestions(user_id, status);
CREATE INDEX idx_widget_analytics_user ON widget_analytics(user_id);
...
CREATE INDEX idx_user_locales_locale ON user_locales(locale_code); 